      ...
      if (!captchaValue) {
        ...
        try {
          ...
          if (result.error) {
            ...
            if (result.id) {
              // Assuming the response contains the comment ID or some other indicator of success
              getComments()
  ...
  return (
    <div id='comment' className='container mx-auto max-w-2xl flex justify-left flex-wrap'>
      <details className='collapse collapse-arrow bg-base-200'>
        <summary ref={commentFormRef} className='collapse-title text-xl font-medium'>
